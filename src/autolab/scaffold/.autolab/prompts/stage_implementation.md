...
4. Include short bounded excerpts for failing commands and explain remediation.
5. Run `{{python_bin}} .autolab/verifiers/template_fill.py --stage implementation` and fix failures.
