...
DEFAULT_PLAN_APPROVAL_ENABLED = True
DEFAULT_PLAN_APPROVAL_REQUIRE_FOR_PROJECT_WIDE_TASKS = True
DEFAULT_PLAN_APPROVAL_MAX_TASKS_WITHOUT_APPROVAL = 6
DEFAULT_PLAN_APPROVAL_MAX_WAVES_WITHOUT_APPROVAL = 2
DEFAULT_PLAN_APPROVAL_MAX_PROJECT_WIDE_PATHS_WITHOUT_APPROVAL = 3
DEFAULT_PLAN_APPROVAL_REQUIRE_AFTER_RETRIES = True
