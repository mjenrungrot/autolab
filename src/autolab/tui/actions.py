...
ACTION_CATALOG: tuple[ActionSpec, ...] = (
    ...
    ActionSpec(
        ...
        label="Open rendered brief",
        description="Open the concise rendered brief packet for the current stage.",
        kind="view",
        risk_level="low",
        group="home",
        user_label="Open rendered brief",
        help_text="Inspect concise retry/review/handoff summary bullets.",
    ),
    ActionSpec(
        action_id="open_rendered_human",
        label="Open rendered human packet",
        description="Open the rendered human-facing packet for the current stage.",
        kind="view",
        risk_level="low",
        group="home",
        user_label="Open rendered human packet",
        help_text="Inspect the reviewer packet used for human escalation/decisions.",
    ),
    ActionSpec(
